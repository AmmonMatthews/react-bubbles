...
- [ ] Explain what a token is used for.
    ...
    a token is a way for the backend to authenticate a persons identity so they can access specific information. 

- [ ] What steps can you take in your web apps to keep your data secure?

  requiring authorization with every request. 

- [ ] Describe how web servers work.

  web servers hold data that has been stored. When called upon with a request will give data back with the proper authentication.
